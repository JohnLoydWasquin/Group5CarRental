...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // append additional global middleware in the future
        ...
        $middleware->group('api', [
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            // 'throttle:api', // add throttle if needed
        ]);
        ...
        // Example: append middleware to a group
        // $middleware->web(append: [\App\Http\Middleware\EnsureUserIsSubscribed::class]);

        // Example: set middleware execution priority
        $middleware->priority([
